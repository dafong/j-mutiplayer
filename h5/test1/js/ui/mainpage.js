...
export default class MainPage{
    ...
    show(){
        g.h.clearRect(0,0,0)
        var self = this
        // this.drawImage("images/bullet.png",0,0,0,0,0).then(function(){
        ...
        g.h.showLayer([0,1])
        // g.h.dialog("hello",'world')
        // h.showSimpleModal("hello world")
    }
    ...
    ontouchend(t){
        ...
        console.log(t.changedTouches[0].clientX + " " + t.changedTouches[0].clientY)
        console.log(t.changedTouches[0].pageX + " " + t.changedTouches[0].pageY)
